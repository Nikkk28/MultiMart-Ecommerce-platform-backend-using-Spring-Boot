...
public class VendorService {
    ...
    @Transactional
    public void registerVendor(VendorRegistrationDto registrationDto, String username) {
        ...
        if (vendorRepository.existsByStoreName(registrationDto.getStoreName())) {
        ...
        Vendor vendor = Vendor.builder()
                ...
                .storeAddress(mapToAddress(registrationDto.getStoreAddress()))
                .specialty(registrationDto.getSpecialty())
